...
#define STRING_CONFIG_H_AUTHOR "(inspire3d.com.au)"   //RR was "(MICROMAKE KOSSEL)" 

#define SERIAL_PORT 0

//  串口通讯速率
#define BAUDRATE 115200   //RR was 115200
...
#define CUSTOM_MENDEL_NAME "DLT180S"    //RR was "UM v2.4"
...
//RR COMMENTED OUT #define DELTA_RADIUS (DELTA_SMOOTH_ROD_OFFSET-DELTA_EFFECTOR_OFFSET-DELTA_CARRIAGE_OFFSET)
#define DELTA_RADIUS (DELTA_SMOOTH_ROD_OFFSET-DELTA_EFFECTOR_OFFSET-DELTA_CARRIAGE_OFFSET-1)  //RR WAS -5.5

// 打印半径
#define DELTA_PRINTABLE_RADIUS 80   //RR was 90.0
...
#define ENABLE_AUTO_BED_LEVELING // 是否开启自动调平功能 
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER 0.8  //RR was 1.6//自动调平设置 过高减小 过低增大
...
#define MANUAL_Z_HOME_POS 169.0 //RR was 230//306.6 // Z轴高度设置
...
#define ABS_PREHEAT_HOTEND_TEMP 225   //RR was 240
#define ABS_PREHEAT_HPB_TEMP 110      //RR was 100
